...
export default class Api extends Command {
    ...
    protected description =
        'Call a generic API on a specific VolxitCloud machine. Use carefully only if you really know what you are doing!'
    ...
    protected options = (params?: IParams): IOption[] => [
        ...
        CliHelper.get().getEnsureAuthenticationOption(
            ...
            async (machine: IMachine) => {
                ...
                try {
                    await CliApiManager.get(machine).getVolxitInfo()
                } catch (e) {
    ...
    protected async preAction(
        ...
        StdOutUtil.printMessage(
            'Call generic VolxitCloud API [Experimental Feature]...\n'
        )
