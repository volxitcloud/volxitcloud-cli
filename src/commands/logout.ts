...
export default class List extends Command {
    ...
    protected description =
        'Logout from a VolxitCloud machine and clear auth info.'
    ...
    protected options = (params?: IParams): IOption[] => [
        this.getDefaultConfigFileOption(),
        {
            ...
            type: 'list',
            message: params
                ? 'select the VolxitCloud machine name you want to logout from'
                : 'VolxitCloud machine name to logout from',
        ...
        },
        {
            ...
            type: 'confirm',
            message: () =>
                'are you sure you want to logout from this VolxitCloud machine?', // Use function to not append ':' on question message generation
            default: false,
            hide: true,
    ...
    protected async preAction(
        ...
        StdOutUtil.printMessage('Logout from a VolxitCloud machine...\n')
