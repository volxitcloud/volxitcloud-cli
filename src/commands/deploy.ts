...
export default class Deploy extends Command {
    ...
    protected description =
        "Deploy your app to a specific VolxitCloud machine. You'll be prompted for missing parameters."
    ...
    protected options = (params?: IParams): IOption[] => [
        ...
        },
        {
            ...
            type: 'input',
            default:
                params && (process.env.VOLXITCLOUD_DEFAULT_BRANCH || 'master'),
            when:
        ...
        },
        {
            ...
            message:
                'tar file to be uploaded, must contain volxit-definition file',
            type: 'input',
            when: false
        },
        {
            ...
            message:
                'image name to be deployed, it should either exist on server, or it has to be public, or on a private repository that VolxitCloud has access to',
            type: 'input',
            when: false
        },
        {
    ...
    protected async preAction(
        ...
        StdOutUtil.printMessage('Preparing deployment to VolxitCloud...\n')
                ...
                if (
                    ...
                    StdOutUtil.printError(
                        `You have to first login to ${StdOutUtil.getColoredMachineName(
                            possibleApp.machineNameToDeploy
                        )} VolxitCloud machine to use previously saved deploy options from this directory with --default.\n`,
                        true
                    )
                }
